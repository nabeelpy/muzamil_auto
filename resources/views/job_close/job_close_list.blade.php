            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Job Close List</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Job Close List</h4>
                            <!-- Ibrahim add -->
{{--                        <button >--}}
...
{{--                            <form action="{{route('job_close.index')}}" method="get">--}}
...
{{--                                            <td>{{$brand->name}}</td>--}}
                                            <td>{{$brand->jc_job_no}}</td>
                                            <td>{{$brand->tech_name}}</td>
                                            <td>{{$brand->jcr_name}}</td>
                                            <td>{{$brand->jc_remarks}}</td>

                                            <td>{{ date('d-m-Y', strtotime( $brand->jc_created_at )) }}</td>
{{--                                            <td>{{$brand->jc_updated_at}}</td>--}}
{{--                                            <td><a href="{{route('job_close.edit',$brand->jc_id)}}"><i class="fas fa-edit"></i></a></td>--}}
