            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Create Party</a></li>
                    </ol>
                </div>
            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="party"
                                                           name="party" placeholder="Enter a Party.." autofocus>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="number"
                                                           name="number" placeholder="Enter a Party.." autofocus onkeypress="return numberFormatter(event)">
                                                </div>
                                            </div>
