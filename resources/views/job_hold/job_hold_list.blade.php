            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Job Hold List</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Job Hold List</h4>
                            <!-- Ibrahim add -->
{{--                        <button >--}}
...
{{--                            <form action="{{route('job_hold.index')}}" method="get">--}}
...
{{--                                        <th>Actions</th>--}}
                                    ...
                                    @foreach($query as $brand)
                                        <tr>
                                            <td>{{$sr}}</td>
                                            <td>{{$brand->jh_job_no}}</td>
{{--                                            <td>{{$brand->name}}</td>--}}
                                            <td>{{$brand->tech_name}}</td>
                                            <td>{{$brand->jhr_name}}</td>
                                            <td>{{$brand->jh_remarks}}</td>

                                            <td>{{ date('d-m-Y', strtotime( $brand->jh_created_at )) }}</td>
{{--                                            <td>{{$brand->jh_updated_at}}</td>--}}
{{--                                            <td><a href="{{route('job_hold.edit',$brand->jh_id)}}"><i class="fas fa-edit"></i></a></td>--}}
