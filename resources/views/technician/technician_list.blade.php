            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        ...
                        <p class="mb-1">Technician List</p>
                    </div>
                </div>
...
{{--                                        <th>Updated At</th>--}}
                                    ...
                                    @foreach($query as $brand)
                                        <tr>
                                            ...
                                            <td>{{$brand->status}}</td>
                                            <td>{{$brand->tech_status}}</td>
{{--                                            <td>{{$brand->name}}</td>--}}
                                            <td>{{$brand->tech_created_at}}</td>
{{--                                            <td>{{$brand->tech_updated_at}}</td>--}}
                                            <td><a href="{{route('edit_technician',$brand->tech_id)}}"><i class="fas fa-edit"></i></a></td>
                                        </tr>
