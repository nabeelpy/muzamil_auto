                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="form-valide" id="form" action="{{route('update_category', $category->cat_id)}}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <select id="bra_name" name="bra_name">
                                                        ...
                                                        @foreach($brands as $brand)
                                                            <option value="{{$brand->bra_id}}" {{$category->cat_bra_id == $brand->bra_id ? 'selected="selected"':'' }}>
                                                                {{$brand->bra_name}}</option>
                                                        @endforeach
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="cat_name"
                                                           name="cat_name" placeholder="Enter a Category.." value="{{ $category->cat_name }}">
                                                </div>
                                            </div>
