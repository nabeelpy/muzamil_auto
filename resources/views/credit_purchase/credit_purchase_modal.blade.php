...
@section('print_cntnt')
    ...
    <div class="itm_vchr_rmrks">
        ...
        <a href="{{ route('credit_purchase_modal_view_details_pdf_sh',['id'=>$brand->cpi_pi_id]) }}"
        ...
        <iframe style="display: none" id="printf" name="printf"
                src="{{ route('credit_purchase_modal_view_details_pdf_sh',['id'=>$brand->cpi_pi_id]) }}" title="W3Schools Free Online Web
            Tutorials">
            Iframe
        </iframe>
