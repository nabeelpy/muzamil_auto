...
{{--                    </p>--}}
    ...
    <div class="itm_vchr_rmrks">
        ...
        <a href="{{ route('sale_invoice_modal_view_details_pdf_sh',['id'=>$brand->sii_si_id]) }}"
        ...
        <iframe style="display: none" id="printf" name="printf"
                src="{{ route('sale_invoice_modal_view_details_pdf_sh',['id'=>$brand->sii_si_id]) }}" title="W3Schools Free Online Web
            Tutorials">
            Iframe
        </iframe>
