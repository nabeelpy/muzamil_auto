            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        ...
                        <p class="mb-1">Job Re-Open List</p>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Job Re-Open List</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Job Re-Open List</h4>
                            <!-- Ibrahim add -->
{{--                        <button >--}}
...
{{--                            <form action="{{route('job_re_open.index')}}" method="get">--}}
...
{{--                                        <th>Actions</th>--}}
                                    ...
                                    @foreach($query as $job_re_open)
                                        <tr>
                                            <td>{{$sr}}</td>
                                            <td>{{$job_re_open->jro_job_no}}</td>
{{--                                            <td>{{$job_re_open->name}}</td>--}}

                                            <td>{{$job_re_open->jro_reason}}</td>
                                            <td>{{$job_re_open->jro_remarks}}</td>

                                            <td>{{ date('d-m-Y', strtotime( $job_re_open->jro_created_at )) }}</td>
{{--                                            <td>{{$job_re_open->jro_updated_at}}</td>--}}
{{--                                            <td><a href="{{route('job_re_open.edit',$job_re_open->jro_id)}}"><i class="fas fa-edit"></i></a></td>--}}
