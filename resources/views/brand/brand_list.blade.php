...
{{--                                        <td>{{$brand->name}}</td>--}}
                                        <td> {{ date('d-m-Y', strtotime( $brand->bra_created_at )) }}</td>
{{--                                        <td>{{$brand->bra_updated_at}}</td>--}}
                                        <td><a href="{{route('edit_brand',$brand->bra_id)}}"><i class="fas fa-edit"></i></a></td>
                                    </tr>
